...
# Download handouts and example data: bit.ly/polnet2016
# Online tutorial: kateto.net/polnet2016
...
# There are a number of libraries like 'rcharts' and 'htmlwidgets' that 
# can help you export interactive web charts from R. We'll take a quick 
# look at 'visNetwork' which can export networks from r to JavaScript. 
